    ...
    <el-row :gutter="20">
        ...
        <el-card class="chart-container" shadow="hover">
          <template #header>
            <span class="section-title"
              ><el-icon><PieChart /></el-icon> 转化漏斗</span
            >
          </template>
      ...
      <el-col :xs="24" :md="12">
        <el-card class="chart-container" shadow="hover">
          <template #header>
            <span class="section-title"
              ><el-icon><Histogram /></el-icon> 渠道转化</span
            >
          </template>
      ...
      <el-col :xs="24" :md="12">
        <el-card class="chart-container" shadow="hover">
          <template #header>
            <span class="section-title"
              ><el-icon><PieChart /></el-icon> 流量来源</span
            >
          </template>
      ...
      <el-col :xs="24" :md="12">
        <el-card class="chart-container" shadow="hover">
          <template #header>
            <span class="section-title"
              ><el-icon><TrendCharts /></el-icon> 活跃趋势</span
            >
          </template>
          <LineChart
            :data="period === '7' ? summary.active7 : summary.active30"
          />
        </el-card>
      </el-col>
    </el-row>
